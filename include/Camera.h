...
public:
    int cameraId, projectionType, horRes,
        verRes;   // projectionType=0 for orthographic, projectionType=1 for perspective
    ...
    Camera(int cameraId, int projectionType, Vec3 position, Vec3 gaze, Vec3 u, Vec3 v, Vec3 w, double left,
